...
class KazagumoPlugin extends better_kazagumo_1.KazagumoPlugin {
    ...
    search(query, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.kazagumo || !this._search)
                throw new better_kazagumo_1.KazagumoError(1, 'kazagumo-spotify is not loaded yet.');
            if (!query)
                throw new better_kazagumo_1.KazagumoError(3, 'Query is required');
    ...
    buildKazagumoTrack(spotifyTrack, requester, thumbnail) {
        var _a, _b;
        return new better_kazagumo_1.KazagumoTrack({
            track: '',
            info: {
                sourceName: 'spotify',
