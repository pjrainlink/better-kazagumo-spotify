...
class SpotifyRequest {
    ...
    makeRequest(endpoint, disableBaseUri = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (request.headers.get('x-ratelimit-remaining') === '0') {
                ...
                throw new better_kazagumo_1.KazagumoError(2, 'Rate limited by spotify');
            }
            this.stats.requests++;
            return data;
        });
    ...
    renewToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!access_token)
                throw new better_kazagumo_1.KazagumoError(3, 'Failed to get access token due to invalid spotify client');
